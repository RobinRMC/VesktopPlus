                ...
                <Button
                    ...
                    onClick={async () => {
                        ...
                        switch (choice) {
                            ...
                            case "ok":
                                Toasts.show({
                                    message: "Vencord installation changed. Fully restart Vesktop+ to apply.",
                                    id: Toasts.genId(),
                            ...
                            case "invalid":
                                Toasts.show({
                                    message:
                                        "You did not choose a valid Vencord installation. Make sure you're selecting the dist dir!",
                                    id: Toasts.genId(),
